...
<AccordionGroup>
  ...
  <Accordion title="Transfer Wallet">
    **Use Case**: Centralized asset management
    
    Transfer wallets automatically transfer all incoming deposits to your internal settlement wallet for centralized management.
